...
"导数定义": {
    ...
    "vn_script": [
        {"char": "sage", "text": "年轻的冒险者，欢迎来到智慧之塔。我是欧拉导师——但别担心，我不是那个真正的欧拉，我只是他的影子，一个愿意教你数学的幽灵。", "expression": "🧙"},
        {"char": "player", "text": "数学？我以为是来打怪的..."},
        {"char": "sage", "text": "哈哈哈哈！数学就是最强大的武器。来，我先问你一个问题。", "expression": "😄"},
        {"char": "sage", "text": "一个球从静止开始下落。第 t 秒时，它已经下落了 5t² 米。在第 2 秒的那一瞬间，它的速度是多少？", "expression": "🤔"},
        {"char": "player", "choices": [
            {"label": "我来算算...应该差不多 20 m/s", "jump": 5},
            {"label": "不知道，一瞬间怎么会有速度？", "jump": 6},
            {"label": "用 (距离÷时间) 算平均速度！", "jump": 5}
        ]},
        {"char": "sage", "text": "没错！但你怎么知道是'20'而不是'差不多20'？你刚才算的其实是平均速度，不是瞬时速度。我们来看看。", "expression": "😊"},
        {"char": "sage", "text": "如果从 t=2 到 t=3 秒，平均速度是 25 m/s。如果从 t=2 到 t=2.1 秒，平均速度是 20.5 m/s。越来越接近 20 了，对不对？", "expression": "🧐"},
        {"char": "sage", "text": "来，我给你看一个魔法窗口。", "bg": "night"},
        {"char": "system", "html": "<div style='text-align:center;padding:20px 0'>✨ 导师挥了挥手，一个光幕出现在空中 ✨<br><span style='font-size:14px;color:var(--text-secondary)'>拖拽蓝点靠近金点，观察斜率的变化</span></div>"},
        {"char": "system", "text": "（拖拽下方的蓝点 B，让它靠近金色的 A 点。观察那条线——它的斜率在变化。）"},
        {"char": "sage", "text": "看见了吗？B 越靠近 A，割线的斜率越接近 2。当 B 和 A 重合时，割线变成了切线。那个切线斜率——2——就是导数 f'(1)。", "expression": "✨"},
        {"char": "player", "text": "所以...导数就是无限逼近后的切线斜率？"},
        {"char": "sage", "text": "精确！你用一个小时发现了人类花了 2000 年才搞清楚的东西。牛顿和莱布尼茨会为你骄傲的。", "expression": "😄"},
        {"char": "sage", "text": "现在你知道了导数是什么——它是'变化的瞬间快照'。物理学用它描述速度，经济学用它找最大利润，AI 用它来学习。你手中的这个工具，是现代文明的基石之一。", "expression": "🧙"},
        {"char": "player", "text": "原来数学不只是做题..."},
        {"char": "sage", "text": "当然不是。数学是人类最伟大的冒险。好了，下面是公式和练习——去征服它们吧，冒险者。", "expression": "⚔️"},
    ],
